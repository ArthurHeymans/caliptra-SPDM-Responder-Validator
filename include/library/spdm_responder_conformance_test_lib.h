...
#define   SPDM_RESPONDER_TEST_CASE_CERTIFICATE_LARGE_SUCCESS                          7
#define   SPDM_RESPONDER_TEST_CASE_CERTIFICATE_LARGE_SIZE_REQ                         8
#define   SPDM_RESPONDER_TEST_CASE_CERTIFICATE_LARGE_INVALID_REQUEST                  9
