...
Assertions 2.8.1 through 2.8.15 are the corresponding SPDM 1.2 capability assertions from Case 2.5, with response version 0x14.
...
Assertion 2.8.19:
    If Param1.SupportedAlgorithms == 0, no Supported Algorithms block is present. If it is 1, the block length, reserved fields, and array counts are structurally valid.
